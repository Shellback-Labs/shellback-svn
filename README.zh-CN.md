...
怀念 TortoiseSVN 的右键效率？Shellback SVN 将经典的文件树驱动 SVN 工作流带到 VS Code——无需命令面板，无需学习曲线，工具就在您期望的位置。
...
- **显示日志**：三栏日志查看器，显示提交历史、消息和更改的文件
- **冲突解决**：可视化冲突面板，提供解决选项（使用我的/使用他们的/编辑/差异对比）
