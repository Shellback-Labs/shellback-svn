...
TortoiseSVN의 마우스 오른쪽 클릭 효율성이 그립나요? Shellback SVN은 클래식한 파일 트리 기반 SVN 워크플로우를 VS Code로 가져옵니다. 명령 팔레트 불필요, 학습 곡선 없음, 필요한 도구를 예상하는 위치에서 바로 사용할 수 있습니다.
...
- **로그 표시**: 커밋 히스토리, 메시지 및 변경된 파일을 표시하는 3창 로그 뷰어
- **충돌 해결**: 해결 옵션(내 것 사용/상대방 것 사용/편집/차이점 비교)이 있는 시각적 충돌 패널
